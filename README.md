...
Консольная утилита для сжатия и распаковки текстовых файлов с использованием алгоритма Хаффмана. Программа анализирует частоту символов, строит бинарное дерево и сохраняет сжатые данные вместе с необходимой для распаковки информацией.

## Особенности

*   **Алгоритм Хаффмана:** Эффективное сжатие текстовых данных.
